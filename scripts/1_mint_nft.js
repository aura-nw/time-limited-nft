...
async function main() {
    ...
    const mintMsg = {
        "mint": {
            "token_id": "dragonite",
            "owner": "aura1uaflg8e46wwtvm0td8mkjeaa0d5s53c92dj85r",
            "token_uri": null,
            "extension": {
                "image": "ipfs://bafkreigfxtuhlitd2oxhz22rvlj3q5q7phwc4rv5pc2pgbx2lwkz3vclsm",
                "image_data": "ipfs://bafkreigfxtuhlitd2oxhz22rvlj3q5q7phwc4rv5pc2pgbx2lwkz3vclsm",
                "external_url": null,
                "description": "A Dragonite",
                "name": "Dragonite",
                "attributes": null,
                ...
                "expires": {
                    "at_time": "1696909818000"
                },
            },
        }
    }

    let mintNftResponse = await execute(minterClient, minterAccount, COLLECTION_ADDRESS, mintMsg);
